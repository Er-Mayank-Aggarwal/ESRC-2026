            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-border-color bg-bg-primary py-2.5 pl-3 pr-10 text-sm text-text-primary placeholder-text-muted outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors"
