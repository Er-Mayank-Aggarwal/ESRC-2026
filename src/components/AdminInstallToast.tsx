...
export default function AdminInstallToast() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-5 fade-in duration-300">
      <div className="flex items-center gap-4 rounded-xl border border-accent/20 bg-bg-secondary p-4 shadow-lg">
        ...
        <div>
          <h3 className="text-[13px] font-bold text-text-primary">Install Admin App</h3>
          <p className="text-[11px] text-text-muted mt-0.5">Get quick access from your home screen</p>
        </div>
